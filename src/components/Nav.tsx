    ...
    <div className={`bg-purple duration-500 h-screen ${isNavOpen ? 'w-80' : 'w-20'}`} onClick={handleClickNavOpen}>
      <div className='flex flex-col justify-center gap-10 py-5'>
        <nav className='relative flex flex-col gap-10'>
          <Icon icon='fluent-emoji-high-contrast:raccoon' className='absolute left-[1rem] text-white w-[40px] h-[40px]' />
          <div className='absolute top-[6rem] left-[1.2rem] flex flex-col justify-center gap-10 cursor-pointer'>
